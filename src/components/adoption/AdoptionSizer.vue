    ...
    <div>
      ...
      <div class="border">
        <div class="sizerContainer">
          <div class="pet-type">
            <button type="button" class="btn btn-default">汪星人</button>
            <button type="button" class="btn btn-default">喵星人</button>
          </div>
            ...
            <div class="dogSizer">
              ...
              <div class="letter">
                <ul class="nav nav-pills" role="tablist">
                  <li role="presentation" class="active"><a href="#doghot" aria-controls="hot" role="tab" data-toggle="tab">热门</a></li>
